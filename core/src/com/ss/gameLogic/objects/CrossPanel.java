...
//            this.blackScreen = blackScreen;
            ...
            Image bgCross = GUI.createImage(TextureAtlasC.CrossPanel, "frmCross");
            ...
            String text = "otherGameVn";
            if(C.lang.idcontry.equals("En"))
                text = "otherGameEn";
            Image lb = GUI.createImage(TextureAtlasC.CrossPanel,text);
            ...
            for (int i=0; i<4; i++) {
                ...
                box   = GUI.createImage(TextureAtlasC.CrossPanel, "stroke");
            ...
            btn(grBtn,bgCross.getX() + bgCross.getWidth()/2 , bgCross.getHeight()*1.1f,"btnGreen", C.lang.lbBtnRed);
...
//            blackScreen.remove();
    ...
    private void btn(Group grbtn,float x,float y,String type,String lb){
        Image btn = GUI.createImage(TextureAtlasC.CrossPanel,type);
        btn.setPosition(0,0);
        grbtn.addActor(btn);
